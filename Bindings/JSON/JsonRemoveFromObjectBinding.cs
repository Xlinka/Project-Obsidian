...
public class JsonRemoveFromObject : FrooxEngine.ProtoFlux.Runtimes.Execution.ObjectFunctionNode<FrooxEngineContext, JObject>
{
    ...
    public override Type NodeType => typeof(JsonRemoveFromObjectNode);

    public JsonRemoveFromObjectNode TypedNodeInstance { get; private set; }
    ...
    public override N Instantiate<N>()
    {
        ...
        JsonRemoveFromObjectNode jsonAddToObjectInstance = (TypedNodeInstance = new JsonRemoveFromObjectNode());
        return jsonAddToObjectInstance as N;
    }

    protected override void AssociateInstanceInternal(INode node)
    {
        if (node is JsonRemoveFromObjectNode typedNodeInstance)
        {
            TypedNodeInstance = typedNodeInstance;
            return;
        }
        throw new ArgumentException("Node instance is not of type " + typeof(JsonRemoveFromObjectNode));
    }
